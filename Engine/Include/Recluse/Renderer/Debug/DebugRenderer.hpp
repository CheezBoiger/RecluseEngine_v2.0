...
public:
    ...
    virtual void        drawText(U32 x, U32 y, F32 scale, const char* text, const Math::Color4& color);

    // Draw text in 3d world position. 
    virtual void        drawText(const Math::Float3& position, const char* text, F32 scale, const Math::Color4& color);

    // Draw a box in the world.
    virtual void        drawBox3d(const Math::Bounds3d& bounds, const Math::Matrix44& transform, const Math::Color4& color, LitType lit = LitType_Flat);

    // Draw a point in the world.
    virtual void        drawPoint(const Math::Float3& position, F32 scale, const Math::Color4& color);
    ...
    virtual void        drawSphere(const Math::Float3& position, F32 radius, const Math::Color4& color, LitType lit = LitType_Flat);
    ...
    virtual void        drawLine(const Math::Float3& start, const Math::Float3& end, F32 scale, const Math::Color4& color);
    ...
    virtual void        drawTriangle(const Math::Float3& v0, const Math::Float3& v1, const Math::Float3& v2, bool clockwise);
    ...
    // \param scale The scale of the ray line, which determines it's thickness.
    // \param color The color of the ray.
    virtual void        drawRay(const Math::Float3& origin, const Math::Float3& direction, F32 scale, const Math::Color4& color);
    ...
    virtual void        drawMesh(PrimitiveTopology topology, 
                            ...
                            LitType debugType = LitType_Flat);
...
private:
    ...
    // Queued draw calls for debug rendering.
