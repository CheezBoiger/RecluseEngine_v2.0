...
uint32_t getFormatSizeBytes(VkFormat format)
{
    switch (format)
    {
        ...
        case VK_FORMAT_D32_SFLOAT_S8_UINT: // This is an 8 byte format 
...
VkPipelineStageFlags getDestinationPipelineStage(VkAccessFlags access)
{
    // for special cases.
...
PhysicalDeviceFeaturesInfo::PhysicalDeviceFeaturesInfo(const PhysicalDeviceFeaturesInfo& info)
{
    features2 = {VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_FEATURES_2};
